...
const VARIANT = {
  ...
  warning: {
    ...
    borderGradientBottom: ["#FFFFFF", "rgba(255, 255, 255, 0)"] as [string, string],
    textColor: "#92400e",
    innerShadowSurface: COLORS.ESCALATION_BG,
  },
  danger: {
    innerBg: COLORS.CRITICAL_BG,
    ...
    borderGradientBottom: ["#FFFFFF", "rgba(255, 255, 255, 0)"] as [string, string],
    textColor: "#991b1b",
    innerShadowSurface: COLORS.CRITICAL_BG,
  },
} as const;
