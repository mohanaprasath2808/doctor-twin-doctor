...
/** Static plans when parent omits `options`. */
...
export type InsuranceBottomSheetModalProps = {
  options?: string[];
...
const InsuranceBottomSheetModal = forwardRef<BSModalType, InsuranceBottomSheetModalProps>(
  (
    {
      options: optionsProp,
      selectedValue = "",
...
InsuranceBottomSheetModal.displayName = "InsuranceBottomSheetModal";
...
export default InsuranceBottomSheetModal;
