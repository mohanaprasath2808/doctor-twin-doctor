...
const HIDE_TABS_ON_ROUTES = [
  ...
  navigationStrings.ENCOUNTER_ORDER_LABS,
  navigationStrings.ADD_PRESCRIPTION,
  navigationStrings.ADD_ENCOUNTER_NOTE,
  navigationStrings.ADD_DIAGNOSIS,
  navigationStrings.ENCOUNTER_SUMMARY,
  navigationStrings.PREVENTIVE_CARE,
  navigationStrings.ORDER_ENGINE,
  navigationStrings.ORDER_UPDATED,
  ...
  navigationStrings.REVENUE_DASHBOARD,
  navigationStrings.ACCOUNT_RECEIVABLE,
  navigationStrings.CLAIMS_NEED_FIXING,
  navigationStrings.CLAIM_DETAIL,
  navigationStrings.UNSIGNED_CLAIMS,
  navigationStrings.CLAIM_SIGNATURE,
  navigationStrings.RETURN_TO_CODER,
  navigationStrings.CODER_REVIEW_QUEUE,
  navigationStrings.BATCH_SIGN_CLAIMS,
  navigationStrings.ACTION_SUCCESS,
  navigationStrings.DENIED_CLAIMS,
  navigationStrings.DENIED_DETAILS,
  navigationStrings.AI_APPEAL_BUILDER,
  navigationStrings.WRITE_OFF,
  navigationStrings.CODING_CORRECTION,
  navigationStrings.RESUBMIT_CLAIM,
  navigationStrings.CLAIM_TIMELINE,
  navigationStrings.PAYMENTS_MONTH_TO_DATE,
  navigationStrings.CLAIM_CORRECTION,
  navigationStrings.PAYMENT_RECONCILIATION,
  navigationStrings.ADJUST_PAYMENT,
  navigationStrings.CHARGES_MONTH_TO_DATE,
  navigationStrings.ENCOUNTER_CHARGE_EDITOR,
  navigationStrings.SEND_OPTIONS,
  navigationStrings.PACKET_PREVIEW,
