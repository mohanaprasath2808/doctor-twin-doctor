...
export const INSURANCE_STATUS_OPTIONS = ["Verified", "Pending", "Invalid"];

type InsuranceStatusBottomSheetModalProps = {
  selectedValue: string;
  onSelectDone: (value: string) => void;
  onDismiss?: () => void;
};

const InsuranceStatusBottomSheetModal = forwardRef<
  BSModal,
  InsuranceStatusBottomSheetModalProps
          ...
          renderItem={({ item, index }) => {
            ...
            return (
              <Pressable
                style={[
                  styles.optionRow,
                  index !== INSURANCE_STATUS_OPTIONS.length - 1 && styles.optionSeparator,
                ]}
...
InsuranceStatusBottomSheetModal.displayName = "InsuranceStatusBottomSheetModal";

export default InsuranceStatusBottomSheetModal;
