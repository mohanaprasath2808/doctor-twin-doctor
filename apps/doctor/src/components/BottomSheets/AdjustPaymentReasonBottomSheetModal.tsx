...
export const ADJUST_PAYMENT_REASON_OPTIONS = [
  "Contractual",
  "Write-off",
  "Error",
] as const;

type AdjustPaymentReasonBottomSheetModalProps = {
  selectedValue: string;
  onSelectDone: (value: string) => void;
  onDismiss?: () => void;
};

const AdjustPaymentReasonBottomSheetModal = forwardRef<
  BSModal,
  AdjustPaymentReasonBottomSheetModalProps
  ...
  return (
    ...
    >
      <BottomSheetView style={styles.content}>
        ...
        <FlatList
          data={ADJUST_PAYMENT_REASON_OPTIONS}
          ...
          renderItem={({ item, index }) => {
            ...
            return (
              <Pressable
                style={[
                  styles.optionRow,
                  index !== ADJUST_PAYMENT_REASON_OPTIONS.length - 1 && styles.optionSeparator,
                ]}
...
AdjustPaymentReasonBottomSheetModal.displayName = "AdjustPaymentReasonBottomSheetModal";

export default AdjustPaymentReasonBottomSheetModal;
