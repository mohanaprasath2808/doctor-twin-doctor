...
export const ESCALATE_PRIORITY_OPTIONS = ["Low", "Medium", "High", "Urgent"] as const;

type EscalatePriorityBottomSheetModalProps = {
  selectedValue: string;
  onSelectDone: (value: string) => void;
  onDismiss?: () => void;
};

const EscalatePriorityBottomSheetModal = forwardRef<
  BSModal,
  EscalatePriorityBottomSheetModalProps
  ...
  return (
    ...
    >
      <BottomSheetView style={styles.content}>
        ...
        <FlatList
          data={ESCALATE_PRIORITY_OPTIONS}
          ...
          renderItem={({ item, index }) => {
            ...
            return (
              <Pressable
                style={[
                  styles.optionRow,
                  index !== ESCALATE_PRIORITY_OPTIONS.length - 1 && styles.optionSeparator,
                ]}
...
EscalatePriorityBottomSheetModal.displayName = "EscalatePriorityBottomSheetModal";

export default EscalatePriorityBottomSheetModal;
