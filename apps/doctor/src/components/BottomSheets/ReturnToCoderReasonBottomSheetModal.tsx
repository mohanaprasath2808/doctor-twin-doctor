...
export const RETURN_TO_CODER_REASON_OPTIONS = [
  "CPT mismatch",
...
type ReturnToCoderReasonBottomSheetModalProps = {
  selectedValue: string;
  onSelectDone: (value: string) => void;
  onDismiss?: () => void;
};

const ReturnToCoderReasonBottomSheetModal = forwardRef<
  BSModal,
  ReturnToCoderReasonBottomSheetModalProps
  ...
  return (
    ...
    >
      <BottomSheetView style={styles.content}>
        ...
        <FlatList
          data={RETURN_TO_CODER_REASON_OPTIONS}
...
ReturnToCoderReasonBottomSheetModal.displayName = "ReturnToCoderReasonBottomSheetModal";

export default ReturnToCoderReasonBottomSheetModal;
