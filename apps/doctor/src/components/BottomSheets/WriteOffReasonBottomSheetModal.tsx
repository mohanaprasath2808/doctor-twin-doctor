...
type WriteOffReasonBottomSheetModalProps = {
  selectedValue: string;
  onSelectDone: (value: string) => void;
  onDismiss?: () => void;
};

const WriteOffReasonBottomSheetModal = forwardRef<
  BSModal,
  WriteOffReasonBottomSheetModalProps
          ...
          renderItem={({ item, index }) => {
            ...
            return (
              <Pressable
                style={[
                  styles.optionRow,
                  index !== WRITE_OFF_REASON_OPTIONS.length - 1 && styles.optionSeparator,
                ]}
...
WriteOffReasonBottomSheetModal.displayName = "WriteOffReasonBottomSheetModal";

export default WriteOffReasonBottomSheetModal;
