...
const VARIANT = {
  ...
  warning: {
    ...
    borderGradientBottom: ["#FFFFFF", "rgba(255, 255, 255, 0)"] as [string, string],
    textColor: "#92400e",
    innerShadowSurface: COLORS.ESCALATION,
  },
  danger: {
    innerBg: COLORS.ALERT_LIGHT,
    ...
    borderGradientBottom: ["#FFFFFF", "rgba(255, 255, 255, 0)"] as [string, string],
    textColor: "#991b1b",
    innerShadowSurface: COLORS.ALERT_LIGHT,
  },
} as const;
      ...
      <View style={[styles.outer, { borderRadius }]}>
        ...
        <View style={[styles.border, { borderRadius }]}>
          ...
          <View
            style={[
              styles.inner,
              { borderRadius: innerRadius, backgroundColor: cfg.innerBg },
            ]}
