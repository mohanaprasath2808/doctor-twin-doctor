      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <NeumorphicCard outerStyle={styles.infoOuter} innerStyle={styles.infoInner} borderRadius={10}>
          <View style={styles.infoRow}>
            <InnerShadowIcon icon={<MessageIcon width={16} height={16} />} size={30} />
            <View>
          ...
          <Text style={styles.messageBody}>We're scheduling you for a follow-up visit.{"\n"}Expect a call soon.</Text>
        </NeumorphicCard>
...
const styles = StyleSheet.create({
  ...
  avatarWrapper: { width: 170, height: 170, marginTop: 8 },
  avatarImage: { width: 86, height: 86, borderRadius: 43 },
  title: { marginTop: 2, textAlign: "center", color: COLORS.TEXT_DARK, fontSize: 18, fontWeight: "500" },
  infoOuter: { marginTop: 16 },
  infoInner: { borderRadius: 10, padding: 10 },
  infoRow: { flexDirection: "row", alignItems: "center", gap: 8 },
  infoTitle: { color: COLORS.TEXT_DARK, fontSize: 12, fontWeight: "500" },
  infoSub: { color: COLORS.TEXT_60, fontSize: 10, fontWeight: "400", marginTop: 1 },
  divider: { height: 1, backgroundColor: COLORS.TEXT_10, marginVertical: 12 },
  messageTitle: { color: COLORS.TEXT_DARK, fontSize: 12, fontWeight: "500" },
  messageBody: { color: COLORS.TEXT_60, fontSize: 12, fontWeight: "400", marginTop: 6, lineHeight: 17 },
  doneBtn: { marginTop: 24, height: 44, borderRadius: 22 },
});
