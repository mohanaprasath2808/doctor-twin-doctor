...
import WriteOffReasonBottomSheetModal from "../../../../components/BottomSheets/WriteOffReasonBottomSheetModal";
...
const WriteOff = () => {
  ...
  const [reason, setReason] = useState("Contractual");
  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={["top"]}>
      ...
      <WriteOffReasonBottomSheetModal
        ref={reasonSheetRef}
