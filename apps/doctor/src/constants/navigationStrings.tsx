const navigationStrings = {
  ...
  UNSIGNED_CLAIMS: "UnsignedClaims",
  CLAIM_SIGNATURE: "ClaimSignature",
  RETURN_TO_CODER: "ReturnToCoder",
  CODER_REVIEW_QUEUE: "CoderReviewQueue",
  BATCH_SIGN_CLAIMS: "BatchSignClaims",
  ACTION_SUCCESS: "ActionSuccess",
  DENIED_CLAIMS: "DeniedClaims",
  DENIED_DETAILS: "DeniedDetails",
  AI_APPEAL_BUILDER: "AIAppealBuilder",
  WRITE_OFF: "WriteOff",
  CODING_CORRECTION: "CodingCorrection",
  RESUBMIT_CLAIM: "ResubmitClaim",
  CLAIM_TIMELINE: "ClaimTimeline",
  PAYMENTS_MONTH_TO_DATE: "PaymentsMonthToDate",
  CLAIM_CORRECTION: "ClaimCorrection",
  PAYMENT_RECONCILIATION: "PaymentReconciliation",
  ADJUST_PAYMENT: "AdjustPayment",
  CHARGES_MONTH_TO_DATE: "ChargesMonthToDate",
  ENCOUNTER_CHARGE_EDITOR: "EncounterChargeEditor",
  SEND_OPTIONS: "SendOptions",
  PACKET_PREVIEW: "PacketPreview",
  SUBMIT_CLAIM: "SubmitClaim",
  UPLOAD_DOCUMENTS: "UploadDocuments",
  REVENUE_PDF_PREVIEW: "RevenuePdfPreview",
  CLAIM_WORKLIST: "ClaimWorklist",
  ESCALATE_ISSUE: "EscalateIssue",
  BILLING_ALERTS: "BillingAlerts",
  MESSAGE_TO_BILLER: "MessageToBiller",
  DENIAL_REASONS_STATISTICS: "DenialReasonsStatistics",
