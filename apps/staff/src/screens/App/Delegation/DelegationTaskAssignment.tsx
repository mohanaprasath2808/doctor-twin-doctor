...
const styles = StyleSheet.create({
  ...
  statusText: { fontSize: 11, fontWeight: "600", fontFamily: "SF-Pro-Display-Semibold" },
  inputLabel: { marginTop: 16, fontSize: 12, fontWeight: "400", fontFamily: "SF-Pro-Display-Regular", color: COLORS.TEXT_60 },
