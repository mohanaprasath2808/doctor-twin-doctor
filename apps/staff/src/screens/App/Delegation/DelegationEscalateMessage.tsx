...
const styles = StyleSheet.create({
  ...
  patientName: { fontSize: 14, fontWeight: "500", fontFamily: "SF-Pro-Display-Semibold", color: COLORS.TEXT_DARK },
  meta: { marginTop: 3, fontSize: 12, fontWeight: "400", fontFamily: "SF-Pro-Display-Regular", color: COLORS.TEXT_70 },
  ...
  doctorName: { fontSize: 14, fontWeight: "500", fontFamily: "SF-Pro-Display-Semibold", color: COLORS.TEXT_DARK },
  formInner: { paddingHorizontal: 10, paddingVertical: 14 },
  label: { fontSize: 12, fontWeight: "400", fontFamily: "SF-Pro-Display-Regular", color: COLORS.TEXT_60 },
  labelWithTop: { marginTop: 14, fontSize: 12, fontWeight: "400", fontFamily: "SF-Pro-Display-Regular", color: COLORS.TEXT_60 },
  priorityInput: { marginTop: 6 },
  reasonInput: { marginTop: 6 },
  reasonInputField: { fontSize: 14, fontWeight: "400", fontFamily: "SF-Pro-Display-Regular", color: COLORS.TEXT_40 },
