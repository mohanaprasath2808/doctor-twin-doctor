...
const NURSES = [
  { id: "eva", name: "Dr. Eva" },
  { id: "jenn", name: "Dr. Jenn P" },
  { id: "annie-1", name: "Dr. Annie" },
  { id: "annie-2", name: "Dr. Annie" },
];
...
export default EscalateMessage;
...
const styles = StyleSheet.create({
  ...
  patientRow: { flexDirection: "row", alignItems: "flex-start", gap: 10 },
  patientAvatar: { width: 40, height: 40, borderRadius: 29 },
  patientText: { flex: 1, flexDirection: "column" },
  ...
  label: { fontSize: 14, fontWeight: "500", color: COLORS.TEXT_60 },
  labelWithTop: { marginTop: 14, fontSize: 14, fontWeight: "500", color: COLORS.TEXT_60 },
