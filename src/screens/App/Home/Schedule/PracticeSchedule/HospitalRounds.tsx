    ...
    >
        ...
        <View style={styles.topTextWrap}>
          ...
          <View style={styles.timeRow}>
            ...
            <Text style={styles.timeText}>
              ...
              <Text style={styles.timeValue}> {item.updatedAt}</Text>
            </Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.metaRow}>
        ...
        <View style={styles.metaCol}>
          ...
          <Text style={styles.metaValue}>{item.diagnosis}</Text>
        </View>
      </View>
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        />
        <Text style={styles.headerTitle}>Hospital Rounds</Text>
...
const styles = StyleSheet.create({
  ...
  timeText: { fontSize: 14, color: COLORS.TEXT_60, fontWeight: "500" },
  timeLabel: { color: COLORS.TEXT_60, fontWeight: "400" },
  timeValue: { color: COLORS.TEXT_80, fontWeight: "500" },
  metaRow: {
    marginTop: 12,
    flexDirection: "row",
    justifyContent: "space-between",
  ...
  metaCol: { width: "48%" },
  metaLabel: { fontSize: 14, color: COLORS.TEXT_60, fontWeight: "400" },
  metaValue: {
    marginTop: 3,
    fontSize: 14,
